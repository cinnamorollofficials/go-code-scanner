...
Authoritative technical specifications, command reference, and rule catalog for `security-review` (Go Code Scanner).
...
- **[Configuration Overview](/reference/configuration)**: Core schema structure, root fields, and validation instructions.
- **[Generated Field Reference](/reference/config/generated-reference)**: Synchronized field-by-field reference table generated directly from Go struct definitions.
