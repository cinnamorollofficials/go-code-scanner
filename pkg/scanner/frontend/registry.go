...
var Registry = map[string]RuleDefinition{
	"frontend/dom-injection": {
		...
		Documentation:  "https://cinnamorollofficials.github.io/go-code-scanner/features/client-scanning#dom-injection",
		Framework:      "vanilla",
		Confidence:     "HIGH",
		Sink:           "innerHTML",
	...
	"frontend/unsafe-execution": {
		...
		Documentation:  "https://cinnamorollofficials.github.io/go-code-scanner/features/client-scanning#dynamic-code-execution",
		Framework:      "vanilla",
		Confidence:     "HIGH",
		Sink:           "eval",
		Source:         "user-input",
	...
	"frontend/unsafe-messaging": {
		...
		Documentation:  "https://cinnamorollofficials.github.io/go-code-scanner/features/client-scanning",
		Framework:      "vanilla",
		Confidence:     "HIGH",
		Sink:           "postMessage",
		Source:         "event.data",
	...
	"frontend/client-credential-exposure": {
		...
		Documentation:  "https://cinnamorollofficials.github.io/go-code-scanner/features/client-scanning#exposure-of-client-secrets",
		Framework:      "vanilla",
		Confidence:     "HIGH",
		Sink:           "localStorage",
		Source:         "env",
	...
	"frontend/telemetry-privacy-leak": {
		...
		Documentation:  "https://cinnamorollofficials.github.io/go-code-scanner/features/client-scanning#privacy-telemetry-leaks",
		Framework:      "vanilla",
		Confidence:     "MEDIUM",
		Sink:           "console.log",
		Source:         "user-object",
	...
	"frontend/missing-subresource-integrity": {
		ID:             "frontend/missing-subresource-integrity",
		Domain:         finding.Security,
		Category:       "integrity",
		Severity:       finding.High,
		Description:    "Cross-origin script or stylesheet loaded without Subresource Integrity (SRI)",
		Recommendation: "Add integrity and crossorigin attributes to external script/link tags",
		Documentation:  "https://cinnamorollofficials.github.io/go-code-scanner/features/client-scanning",
		Framework:      "vanilla",
		Confidence:     "HIGH",
		Sink:           "script/link",
		Source:         "cross-origin-resource",
		Tags:           []string{"frontend", "security", "sri", "integrity"},
	},
	"frontend/insecure-resource-url": {
		ID:             "frontend/insecure-resource-url",
		Domain:         finding.Security,
		Category:       "transport",
		Severity:       finding.High,
		...
		Sink:           "src/href",
		Source:         "http-url",
		Tags:           []string{"frontend", "security", "http", "transport"},
	},
	"frontend/unversioned-remote-resource": {
		ID:             "frontend/unversioned-remote-resource",
		Domain:         finding.SupplyChain,
		Category:       "dependency_lock",
		Severity:       finding.Medium,
		Description:    "Remote script or stylesheet loaded without a version pin",
		Recommendation: "Pin remote resources to a specific version or use SRI hash to ensure reproducibility",
		Documentation:  "https://cinnamorollofficials.github.io/go-code-scanner/features/client-scanning",
		Framework:      "vanilla",
		Confidence:     "MEDIUM",
		Sink:           "src/href",
		Source:         "remote-resource",
		Tags:           []string{"frontend", "supply-chain", "remote-resource"},
	},
}
