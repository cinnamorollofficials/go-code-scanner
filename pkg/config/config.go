...
import (
	...
	"github.com/cinnamorollofficials/go-code-scanner/pkg/scanner/adapters"
...
func Default() Config {
	return Config{
		...
		IncludeExtensions:   []string{".go", ".ts", ".tsx", ".js", ".jsx", ".mjs", ".cjs", ".mts", ".cts", ".html", ".vue", ".svelte", ".yaml", ".yml", ".json"},
		ExcludeDirectories:  []string{".git", "node_modules", "vendor", "dist", "build", ".next", ".nuxt", ".svelte-kit", ".output", "out", "bin"},
