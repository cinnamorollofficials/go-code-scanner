...
var Registry = map[string]RuleDefinition{
	...
	"frontend/sveltekit-private-env-in-client": {
		ID:             "frontend/sveltekit-private-env-in-client",
		Domain:         finding.Security,
		Category:       "credential-exposure",
		Severity:       finding.High,
		Description:    "Client code importing SvelteKit private environment module",
		Recommendation: "Only import $env/static/public or $env/dynamic/public in client code",
		Documentation:  "https://github.com/cinnamorollofficials/go-code-scanner/blob/main/docs/frontend-scanning-contract.md",
		Framework:      "svelte",
		Confidence:     "HIGH",
		Sink:           "import",
		Source:         "private-env-module",
		Tags:           []string{"frontend", "svelte", "env", "secrets"},
	},
	"frontend/sveltekit-server-module-in-client": {
		ID:             "frontend/sveltekit-server-module-in-client",
		Domain:         finding.Hardening,
		Category:       "boundary",
		Severity:       finding.High,
		Description:    "Client code importing SvelteKit server loader or .server module",
		Recommendation: "Do not import .server modules in client components",
		Documentation:  "https://github.com/cinnamorollofficials/go-code-scanner/blob/main/docs/frontend-scanning-contract.md",
		Framework:      "svelte",
		Confidence:     "HIGH",
		Sink:           "import",
